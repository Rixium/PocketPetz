...
for _, item in pairs(items) do
    if(item.ItemData.ItemType == "Pet") then
        ...
        currentSlot.Slot.MouseButton1Click:Connect(function() 
...
slots[4].Slot.MouseButton1Click:Connect(ShowLegendsPopup);
slots[5].Slot.MouseButton1Click:Connect(ShowLegendsPopup);